...
| `identifier`  | An identifier is an RFC 4122-compliant Version 4 UUID. The UUID MUST be generated according to the algorithm(s) defined in RFC 4122, section 4.4 (Version 4 UUID) [RFC4122](https://docs.oasis-open.org/cti/taxii/v2.1/os/taxii-v2.1-os.html#dlnoxmeb3ux0). |
